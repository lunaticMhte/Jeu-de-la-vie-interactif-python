...
temps_ecoule = 0
temps_interval = 500  # Interval de temps entre les générations en millisecondes

# Compteur de générations
generations = 0

# État de génération aléatoire
...
while en_cours:
    ...
    if not pause and pygame.time.get_ticks() - temps_ecoule > temps_interval:
        ...
        # Mise à jour de la grille avec les nouvelles générations
    ...
    # Affichage du bouton de génération aléatoire
    ...
    # Gestion de la couleur du bouton lorsqu'il est survolé
